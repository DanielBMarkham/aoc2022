// HOUSEKEEPING/COMMON
let linesExample = System.IO.File.ReadLines("day13/example.txt")   |> Seq.toList;;
let linesProblem1 = System.IO.File.ReadLines("day13/problem1.txt")   |> Seq.toList;;
let linesProblem2 = System.IO.File.ReadLines("day13/problem2.txt")   |> Seq.toList;;
